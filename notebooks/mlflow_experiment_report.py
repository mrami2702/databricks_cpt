...
# This is the path you see in the MLflow UI sidebar — click on your experiment
# and copy the name. It usually starts with /Shared/ or /Users/.
# Example: "/Shared/cpt-sft-mistral"
EXPERIMENT_NAME = ""

# Which run to spotlight — set to None to auto-pick the latest completed run.
# You can find the run ID by clicking on a run in the MLflow UI — it's the
# long string in the URL or at the top of the run page.
